...
import 'package:round_8_mobile_safarni_team3/features/flight_booking/data/repo_imp/flight_repo_imp.dart';
...
Future<void> flightServiceLocator() async {
  ServiceLocator.gi.registerLazySingleton<FlightDataSource>(() => FlightDataSourceImp());
